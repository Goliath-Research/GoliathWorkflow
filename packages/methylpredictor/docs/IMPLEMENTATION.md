...
| **ClassifierConfig** | Built with model_path/model_dir plus optional **classifier_step_snapshot** fields merged from `step_config.classifier` when resolving from `--project`. |
