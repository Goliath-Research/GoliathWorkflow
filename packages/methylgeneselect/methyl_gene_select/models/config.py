...
class GeneSelectionConfig(BaseModel):
    ...
    max_genes: Optional[int] = Field(default=DEFAULT_GENE_FEATURECUTS_MAX_GENES, ge=1)
    max_dmps: Optional[int] = Field(default=DEFAULT_GENE_FEATURECUTS_MAX_DMPS, ge=1)
