...
- `methyl_utils/statistical_tests.py`
  Owns the shared Welch-style mean test, continuous ECDF overlap integration, canonical `effect_size` computation, and `lambda_var` optimization helper.
...
2. Run Welch-style significance testing on aligned means/variances.
