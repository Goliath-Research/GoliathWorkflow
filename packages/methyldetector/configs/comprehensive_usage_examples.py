...
from methyl_detector.models.config import MethylDetectorConfig, MultipleComparisonConfig
...
def example_3_python_api_with_pydantic_config() -> None:
    ...
    try:
        ...
        # Initialize detector
        detector: MethylDetector = MethylDetector(config)
...
def example_4_python_api_with_direct_parameters() -> None:
    ...
    try:
        ...
        detector: MethylDetector = MethylDetector(
            centroid1_path=Path("/path/to/centroid1.h5"),
            centroid2_path=Path("/path/to/centroid2.h5"),
            output_dir=Path("./results"),
            alpha=0.05,
...
def example_7_container_usage() -> None:
    ...
    print("   ```bash")
    print("   cd /home/ubuntu/MethylDetector")
