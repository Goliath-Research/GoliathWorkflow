...
This field is present in the config but **not in the current MethylDetectorConfig schema**. It may be deprecated in favor of `optimize_dmps: true`. The field exists in MethylTrainer but appears to be legacy.
