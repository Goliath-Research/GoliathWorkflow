...
MethylDetector now exports **three separate CSV files** representing the three stages of DMP selection, allowing you to map each stage to genes and compare their biological interpretation.
