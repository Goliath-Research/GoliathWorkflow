...
1. Open Cursor
2. Open the `/home/ubuntu/MethylDetector` folder
...
### Volume Mounts
- `/home/ubuntu/MethylDetector` - The main project directory
...
**See `DOCKER_PERMISSIONS_GUIDE.md` for detailed solutions and alternatives.**
...
sudo chown -R ubuntu:ubuntu /home/ubuntu/MethylDetector
```
