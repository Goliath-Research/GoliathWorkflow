...
docker exec epimethyl bash -c "cd /home/ubuntu/MethylDetector && python -c 'import methyl_detector; print(\"MethylDetector imported successfully\")'"
...
echo "Next steps:"
echo "1. Open Cursor"
echo "2. Open the /home/ubuntu/MethylDetector folder"
