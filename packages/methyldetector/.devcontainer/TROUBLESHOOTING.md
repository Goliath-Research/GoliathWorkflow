...
Command failed: docker compose -f /home/ubuntu/MethylDetector/Work/cuda/docker-compose.yml --profile * config
```
...
docker exec epimethyl bash -c "cd /home/ubuntu/MethylDetector && poetry install --with dev"
```
...
4. **Open Cursor and try again**:
   - Open `/home/ubuntu/MethylDetector` folder
...
5. **If still failing, try manual attachment**:
   ...
   - Choose `/home/ubuntu/MethylDetector` as workspace
...
├── DOCKER_PERMISSIONS_GUIDE.md   # Docker permission solutions
