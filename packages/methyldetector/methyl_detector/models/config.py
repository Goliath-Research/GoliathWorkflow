...
class MethylDetectorConfig(BaseModel):
    ...
    filter_funnel_explore: Optional[FilterFunnelExplore] = Field(
        default=None,
        description="Optional. Sweep effect_size_coverage over a range and write filter_funnel-{chromosome}.csv (n_statistical_dmps, effect_size_coverage, n_biological_dmps). One run; no large DMP CSV. Set to null to disable."
    )
