...
## Using MethylDetector

### Command Line Interface

MethylDetector uses JSON configuration files for all parameters:
...
### Multiple Comparisons
- `methyl_detector_summary_report.txt` - Overall summary
...
- Run `python -m methyl_detector --help` for CLI options
