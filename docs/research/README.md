...
| [methylpipeline_vs_methylit_comparison.md](methylpipeline_vs_methylit_comparison.md) | MethylPipeline vs MethylIT_py 0.4.0: theory, DMP detection, reference selection; empirical agenda |
