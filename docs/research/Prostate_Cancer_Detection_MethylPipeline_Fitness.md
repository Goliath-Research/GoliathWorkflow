...
**Interactive canvas:** open beside chat — [`pca-detection-fitness.canvas.tsx`](/home/ubuntu/.cursor/projects/home-ubuntu-MethylPipeline/canvases/pca-detection-fitness.canvas.tsx)
