...
| [Reference inventory (QNAP)](../deployment/reference-inventory-qnap.md) | Upload/provision map: `s3://goliath/genomes/` ↔ `/work/genomes/` |
...
| [Portal information architecture](portal-ia.md) | EpiPortal study pipeline, monitor/retry, Admin RBAC + contract packs, screen → `portal.sp_*` |
...
**Interactive hub:** [architecture canvas](../canvas/README.md#methylpipeline-architecture) (local vs gateway, config layers, DB contract; open in Cursor after sync) · [portal IA canvas](../canvas/README.md#portal-ia)
...
- **EpiPortal UI / RBAC** → [portal-ia.md](portal-ia.md) + [portal IA canvas](../canvas/README.md#portal-ia) + [portal remote control](portal-remote-control.md) + [config-registry storage RBAC](config-registry.md)
