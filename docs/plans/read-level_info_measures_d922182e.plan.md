...
Design note this implements: [docs/research/methylpipeline_informme_integration.md](docs/research/methylpipeline_informme_integration.md).
...
- `core/patterns.py`: per-tile histogram -> Shannon methylation entropy (normalized by k), epipolymorphism `1 - sum p_i^2`, true PDR (fraction of reads discordant within tile).
