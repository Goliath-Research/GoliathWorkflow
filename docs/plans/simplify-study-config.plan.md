...
[Composable pipeline flexibility](../plans/composable-pipeline-flexibility.plan.md) is **implemented**. The remaining work is to **retire `step_config`** and make the four-layer stack the **only** configuration path for new processing.
...
- Promote plan to [`docs/plans/simplify-study-config.plan.md`](../plans/simplify-study-config.plan.md); update [docs/plans/README.md](../plans/README.md).
...
**Builds on:** [composable-pipeline-flexibility.plan.md](../plans/composable-pipeline-flexibility.plan.md) (programs + IF flags — done).
