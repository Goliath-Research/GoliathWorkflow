...
1. [`workflow_engine/sql_pg/deploy_azure.sh`](../../workflow_engine/sql_pg/deploy_azure.sh) (PostgreSQL) or [`workflow_engine/sql/deploy_azure.sh`](../../workflow_engine/sql/deploy_azure.sh) (Azure SQL)
