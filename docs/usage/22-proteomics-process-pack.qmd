...
DDA / MSFragger / FragPipe (commercial license) is a later addition; it would be a CPU
capability that can also build experimental spectral libraries for the DIA-NN path.
