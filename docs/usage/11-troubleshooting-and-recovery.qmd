...
| Node `RUNNING`, stale lease | Worker crash/restart; claim only serves `READY` | `EXEC portal.sp_reclaim_expired_leases @workflow_instance_id=…, @grace_seconds=60;` (see [lease doc](../architecture/workflow-idempotency-retry-lease.md)) |
