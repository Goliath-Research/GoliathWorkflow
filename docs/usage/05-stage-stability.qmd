...
> **Canonical entry:** [Orchestration (workflow-run)](04-orchestration-workflow-run.qmd). Use `methyl-workflow-run` with an MC stability DomainProgram. The `methyl-validation` commands in this chapter are **legacy**.
...
![Stability stage process model](../diagrams/out/stability-stage.png)
