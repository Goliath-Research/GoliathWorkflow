...
|-----------|---------|----------|
| `buffy_wgbs_pangenome_gene_fc` | `buffy_coat` | WGBS pangenome (methylGrapher, `alignmentMode: pangenome_wgbs`), read-level informME, Houseman deconv, gene FeatureCuts, full lifecycle |
