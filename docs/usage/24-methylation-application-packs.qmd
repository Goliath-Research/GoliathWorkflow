...
|-----------|---------|----------|
| `buffy_wgbs_linear_gene_fc` | `buffy_coat` | **Interim default** linear WGBS (Parabricks); same science knobs as the pangenome pack |
| `buffy_wgbs_pangenome_gene_fc` | `buffy_coat` | **Experimental** WGBS pangenome (methylGrapher, `alignmentMode: pangenome_wgbs`) — opt-in until linear-vs-wgbs acceptance passes |
...
Use `buffy_wgbs_pangenome_gene_fc` only for experimental dual-align compares until
[`docs/plans/wgbs-alignment-decision.plan.md`](../plans/wgbs-alignment-decision.plan.md)
acceptance (DS20M + buffy) passes.
