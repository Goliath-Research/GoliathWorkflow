...
Existing `mc_*` profiles remain for deep statistical exploration. Prefer the `samd_*` ladder for claim-bound studies.
...
6. Fill an evidence package in [`docs/regulatory/validation-evidence-index.md`](../regulatory/validation-evidence-index.md) (release SHA, profile, partitions, metrics paths).

## Program pairing

| Tier | Binary DomainProgram | Staged DomainProgram |
|------|----------------------|----------------------|
| research / enrichment MC | `buffy_healthy_vs_pca/.../buffy_mc_stability.program.json` | `pca1_5_cg/.../pca1_5_mc_stability.program.json` |
