...
1. Pick analyte + **`pipelineProcedure`** (see [ch.24](24-methylation-application-packs.qmd)).
...
- [Methylation application packs](24-methylation-application-packs.qmd) — `pipelineProcedure` recipes (fixed base under HPO)
