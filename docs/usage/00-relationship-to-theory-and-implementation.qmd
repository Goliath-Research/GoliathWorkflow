...
**Canonical orchestration:** [`methyl-workflow-run`](04-orchestration-workflow-run.qmd) with repo DomainPrograms, pipeline profiles, and `/work` study manifests. This is the path for new studies, local development, and production workers.
...
| Need | Read |
|------|------|
| Entry points, program selection | [Orchestration (ch.04)](04-orchestration-workflow-run.qmd) |
