...
|-----------|------|-------|
| [`alzheimer-cfdna/`](alzheimer-cfdna/README.md) | Disease application (Control → MCI → AD, cfDNA) | [Usage ch.21](../../usage/21-alzheimer-cfdna-pack.qmd) |
| [`plant-abiotic-stress/`](plant-abiotic-stress/README.md) | Trait application (Arabidopsis Control vs Drought) | [Usage ch.23](../../usage/23-plant-abiotic-stress-pack.qmd) |

Generic pattern and checklist: [Usage ch.24 Methylation application packs](../../usage/24-methylation-application-packs.qmd).
Operator SaMD ladder: [Usage ch.18](../../usage/18-samd-study-lifecycle.qmd). Scaffold: `methyl-study-init`.
