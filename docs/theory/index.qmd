...
| @sec-methylpredictor-validation | `methylpredictor`, `methylvalidation` | prediction metrics, Monte Carlo validation, stability analysis, production freeze |
