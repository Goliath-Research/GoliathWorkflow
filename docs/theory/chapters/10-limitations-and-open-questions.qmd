...
Cell-type deconvolution (@sec-methyldeconv) is a principled constrained projection, but its accuracy is bounded by the reference basis. Two provisioning caveats apply:
