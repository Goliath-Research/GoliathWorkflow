...
Operator guide: [Usage ch.03 — Sample Prep and QC](../../usage/03-sample-prep-and-qc.qmd). Implementation: [Sample preparation flow](../../implementation/sample-preparation-flow.md). Family detection: `methyl_alignment_qc/core/metrics_family.py`.
