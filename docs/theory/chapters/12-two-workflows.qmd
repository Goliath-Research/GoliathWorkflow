...
`pipeline.cell_deconvolution` in this stage carries the method switch and analyte-driven trees documented in @sec-methyldeconv. The remaining covariates (`derived_measures`, `info_measures`) and the biology step (`enricher`) are described in the [end-to-end workflow](../../architecture/end-to-end-workflow.md) and @sec-methylenricher.
