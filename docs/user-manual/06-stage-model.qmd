...
For `ecdf` + observed-hybrid mapped families (`feature_mode=observed_hybrid`, `feature_family_set!=dmp`), the runtime path is aggregated ECDF OvR package train/predict and skips ECDF second-stage refinement.
