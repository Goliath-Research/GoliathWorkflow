...
REPLACEMENTS: list[tuple[str, str]] = [
    ...
    (r"\[`docs/user-manual/", "[`docs/usage/"),
    (r"user-manual/index\.qmd", "usage/index.qmd"),
    (r"user-manual/14-deployment", "usage/14-deployment-and-distributed-workflow.qmd"),
    (r"user-manual/13-distributed", "usage/13-distributed-methyl-validation.qmd"),
    (r"user-manual/15-optional", "usage/15-optional-hyperparameter-search.qmd"),
    (r"user-manual/(\d{2}-[^`\s\)]+\.qmd)", r"usage/\1"),
    (r"docs/user-manual", "docs/usage"),
    (r"\(user-manual/", "(usage/"),
    (r"`user-manual/", "`usage/"),
    ...
    (r"docs/MethylPipeline-analysis\.qmd", "docs/theory/index.qmd"),
    (r"theory/chapters/14-user-guide\.qmd", "usage/index.qmd"),
    (r"chapters/14-user-guide", "usage/index"),
    (r"theory/chapters/13-configuration-reference\.qmd", "reference/configuration-reference.qmd"),
