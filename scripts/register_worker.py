    ...
    *,
    ...
    if dry_run:
        print(
            ...
            f"cidrs={allowed_cidrs} entra_client_id={entra_client_id}"
        )
        return 0
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                INSERT INTO wf.cluster (
                  ...
                  allowed_source_cidrs, entra_client_id
                )
                VALUES (%s, %s, '/work/epimethyl', '/work/epimethyl', 'ACTIVE', %s::jsonb, %s)
...
WHEN NOT MATCHED THEN
  INSERT (cluster_key, name, shared_storage_uri, worker_mount_path, status, allowed_source_cidrs, entra_client_id)
  VALUES (
