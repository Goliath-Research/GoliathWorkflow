...
echo "Install local packages with:"
echo "  bash scripts/install_all.sh --pipeline-reqs"
echo "Or manually:"
...
echo "  pip install -e packages/methylalignmentqc --no-deps"
echo "  pip install -e packages/methylpredictor --no-deps"
echo "  pip install -e packages/methylvalidation --no-deps"
echo ""
