...
DEFAULT_GTF = "/work/genomes/human_genome/gencode.v49.annotation.gtf"
...
def ensure_site_manifest(cfg: MigrationConfig, *, dry_run: bool) -> List[str]:
    ...
    if SITE_EXAMPLE.is_file():
        ...
        data = {
            "reference_genome": {
                "fasta": "/work/genomes/human_genome/release-114/Homo_sapiens.GRCh38.dna.primary_assembly.fa"
            },
