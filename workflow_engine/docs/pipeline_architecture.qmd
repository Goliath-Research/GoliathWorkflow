...
![presentation-map](../../../docs/diagrams/out/distributed-runtime.svg){width=100%}
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `sample-prep-pipeline.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `cohort-hierarchy.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `schema-tree.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `action-schemas.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `portal-editor.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `domain-program-compile.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `er-diagram.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `scope-hierarchy.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `worker-conditions.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `methylvalidation-flow.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `data-driven-pipeline.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `worker-protocol.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
...
::: {.content-visible when-format="pdf"}
*PDF figure `cluster-storage.svg` missing — run `bash scripts/render_diagrams.sh`.*
:::
