...
| **Runtime** | `workflow_instance`, `node_execution`, `task_lease`, `loop_state`, `execution_context`, `scope_variable`, `instance_cursor`, **`execution_scope`**, **`execution_scope_action_entry`** (`workflow_instance.execution_scope_id` FK, nullable) |
