...
| methylGrapher WGBS align | `methylgrapher.wgbs_align` | External GPU | QC BAM + `{id}.alignment.gaf` + metrics |
...
| methylGrapher WGBS extract | `methylgrapher.wgbs_extract` | External GPU | Graph-aware H5 + patterns + canonical manifest |
