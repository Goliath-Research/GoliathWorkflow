/*
  ...
  wf_instance_extension.sql) so wf_apply_hyperparameter_set can persist
  methyl.hyperparameter.set without a prior script run.
*/
...
/* --- hyperparameter set registry and ledger --- */
