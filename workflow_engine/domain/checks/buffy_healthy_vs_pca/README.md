...
| `../profiles/discovery_gene_featurecuts.profile.json` | Profile for Buffy MC (`runDmpSelection`, gene FeatureCuts, stability axes) |

| `/work` path | Role |
|--------------|------|
| `configs/project_Buffy_healthy_vs_PCa.json` | Cohorts, comparisons, `step_config`, MC iteration count |
